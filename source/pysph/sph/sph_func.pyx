...
cdef class SPHFunctionParticle:
    ...
    cdef void eval(self, int source_pid, 
                   int dest_pid, MultidimensionalKernel kernel, double
                   *nr, double *dnr):
        """
    ...
    cpdef py_eval(self, int source_pid, 
                  int dest_pid, MultidimensionalKernel kernel, 
                  numpy.ndarray nr, numpy.ndarray dnr):
        """
...
cdef class SPHFunctionPoint:
    ...
    cdef void eval(self, Point pnt, int dest_pid, 
                   MultidimensionalKernel kernel, double *nr,
                   double *dnr):
        """
